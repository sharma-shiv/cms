<?php 	
	...
	$l1=($page_no-1)*10;
	$l2=10;
	$str_user="select * from user_details,users where status=2 and users.id=user_details.user_id limit ".$l1.",".$l2;
	...
	<div id="divcontent">
		<div id="sidemenu">
			<ul class="list-group">
				...
				<li class="list-group-item"><a href="activateusers.php">Activate users</a></li>
			</ul>
			<ul class="list-group">
				...
				if($result_user->num_rows>0)
				{
					...
					while($row = $result_user->fetch_assoc())
					{
						if($row['status']==2)
						{
							...
							echo "<td class='td'><a href='activateuser.php?id=".$row['user_id']."'><img src='../assets/images/view.jpg' height=15px width=15px/></a></td>
							echo "</tr>";
						}
					}
