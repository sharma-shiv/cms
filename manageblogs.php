...
<?php 	include "includes/config.php"; 
		...
		$strblog="select * from blogs where status=1 and delete_status=0 and user_id=".$_SESSION['id'];
		$result=$con->query($strblog);
		isset($_GET['page'])?$page_no=$_GET['page']:$page_no=1;
		$str_count="select count(id) as user_count from blogs where delete_status=0 and user_id=".$_SESSION['id'];
		...
		$l1=($page_no-1)*4;
		$l2=4;
		$str_blog="select * from blogs where delete_status=0  and user_id=".$_SESSION['id']." limit ".$l1.",".$l2;
                                ...
                                <ul><?php
                                        ...
                                        <div class="post-item">
                                            ...
                                            <div class="caption">
                                                ...
                                                <a class="btn btn-main btn-sm btn-dashed" href="viewuserblog.php?id=<?php echo $row['id'];?>">READ MORE</a>
                                            </div><!-- /.caption -->
                                            <!-- Begin share Icons -->
...
<!-- Mirrored from demo.warungthemes.com/html/beeanca/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2016 10:10:10 GMT -->
